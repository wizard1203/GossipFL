...
if __name__ == "__main__":
    ...
    if args.dataset == 'pascal_voc':
        ...
        _, _, _, _, net_data_idx_map, train_data_cls_counts = partition_cifar100(
            'cifar100', args.data_dir, partition_method, args.client_num_in_total, args.alpha)
    elif args.dataset == 'cifar10':
        classes = list(range(10))
        _, _, _, _, net_data_idx_map, train_data_cls_counts = partition_cifar10(
            'cifar10', args.data_dir, partition_method, args.client_num_in_total, args.alpha)
    ...
    plt.savefig(args.dataset + '_partition' + str(partition_method) + \
        '_alpha' + str(alpha) + '_clients' + str(client_num) + '.pdf')
