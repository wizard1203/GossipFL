...
NORMAL_DATASET_LIST = ["cifar10", "cifar100", "SVHN",
                        "mnist", "fmnist", "Tiny-ImageNet-200"]
...
class Data_Loader(object):
    ...
    def load_full_data(self):
        ...
        if self.dataset == "SVHN":
            train_ds = self.full_data_obj(self.datadir,  "train", download=True, transform=train_transform)
            test_ds = self.full_data_obj(self.datadir,  "test", download=True, transform=test_transform)
        else:
