...
class Recorder(object):
    ...
    # def refresh_summary(self, args=None, **kwargs):
    #     # if self.summary_status == "new":
    #     #     return self.summary_dict
    #     # elif self.summary_status == "old":
    #     # summary_dict = {}
    #     summary_dict = dict(self.record.mean())
    #     self.summary.update(summary_dict, n_samples=len(self.record))
    #     return self.summary_dict
