...
from model.cv.vggmodel import (vgg11, vgg11_bn, vgg13, vgg13_bn, vgg16, vgg16_bn, vgg19, vgg19_bn)
...
from .model_fedcon import  (ModelFedCon, ModelFedCon_noheader)
...
def create_model(args, model_name, output_dim, pretrained=False, **kwargs):
    ...
    if model_name == "lr" and args.dataset == "mnist":
    ...
    elif model_name == "resnet18-cifar10":
        ...
        model = ResNet50(num_classes=output_dim, args=args)
